...
func NewDarkTheme() Theme {
	...
	return Theme{
		...
		Selected:     lipgloss.NewStyle().Foreground(lipgloss.Color("#E2E8F0")).Border(lipgloss.RoundedBorder()).BorderForeground(highlightColor).Padding(0, 1),
		SelectedWire: lipgloss.NewStyle().Foreground(lipgloss.Color("#E2E8F0")).Border(lipgloss.NormalBorder()).BorderForeground(highlightColor).Padding(0, 1),
...
func NewLightTheme() Theme {
	...
	return Theme{
		...
		Selected:     lipgloss.NewStyle().Foreground(lipgloss.Color("#2D3748")).Border(lipgloss.RoundedBorder()).BorderForeground(highlightColor).Padding(0, 1),
		SelectedWire: lipgloss.NewStyle().Foreground(lipgloss.Color("#2D3748")).Border(lipgloss.NormalBorder()).BorderForeground(highlightColor).Padding(0, 1),
